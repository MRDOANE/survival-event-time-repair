...
if [[ "$MODE" == "smoke" ]]; then
  ...
  RESULTS_ZIP="${RESULTS_ZIP:-/workspace/survival_mastitis_external_smoke_results.zip}"
else
  OUTPUT_DIR="$PROJECT_DIR/outputs/full"
  RESULTS_ZIP="${RESULTS_ZIP:-/workspace/survival_mastitis_external_results.zip}"
fi
